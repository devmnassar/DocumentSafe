...
namespace DocSafe.Web.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            var usersFromDb = _db.Users.Count();
            returnUrl ??= Url.Content("~/User/Document");
            ExternalLogins = (await _signInManager.GetExternalAuthenticationSchemesAsync()).ToList();
            if (ModelState.IsValid)
            {
                ...
                _userManager.AddToRoleAsync(user, StaticDetails.UserRole).GetAwaiter().GetResult();
