...
namespace DocSafe.Web.Areas.User.Controllers
{
    [Authorize]
    [Area("User")]
    public class DocumentController : Controller
    {
        ...
        public DocumentController(IUnitOfWork unitOfWork , IWebHostEnvironment webHostEnvironment)
        {
        ...
        {
            var documentList = _unitOfWork.Documents.GetAll();
        ...
        public IActionResult Upload(Document doc, IFormFile file)
        {
            // Get User Id
            ...
            {
                // Upload Function
                bool fileUpload = _unitOfWork.Documents.SaveFile(doc, file, userId);
                if (!fileUpload)
                {
                    TempData["error"] = "Error While Uploading , Try Later :(";
                    return View();
                }
            }
        ...
        public IActionResult GetAll()
        {
            ...
            List<Document> documentList = _unitOfWork.Documents.GetAll().ToList();
