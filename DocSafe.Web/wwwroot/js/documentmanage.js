...
function loadDataTable(searchQuery = '') {
    ...
    dataTable = $('#tblData').DataTable({
        "ajax": {
            url: searchQuery ? '/admin/documentManage/search' : '/admin/documentManage/getall',
            type: 'GET',
        ...
        "columns": [
            ...
            { data: 'note', "width": "15%" },
            {
                ...
                "render": function (data) {
                    ...
                    <a href="/admin/documentmanage/details/${data}" class="btn btn-primary btn-sm mx-2"><i class="bi bi-pencil-square"></i></a>
                     <a onClick=Delete('/admin/documentmanage/delete/${data}') class="btn btn-danger mx-2"> <i class="bi bi-trash-fill"></i> Delete</a>
                    </div>`;
                },
                "width": "15%"
            }
...
function deleteDocument(id) {
    $.ajax({
        url: '/admin/documentManage/delete/' + id,
        type: 'POST',
        success: function (response) {
            Swal.fire({
                ...
                window.location.href = "/admin/documentManage/index"; // Redirect after delete
            });
        },
        error: function () {
            Swal.fire({
